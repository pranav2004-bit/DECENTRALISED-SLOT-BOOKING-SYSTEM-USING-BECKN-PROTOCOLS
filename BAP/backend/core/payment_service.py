...
simply doesn't exist. Mirrors BPP's `core/payment_service.py` — kept as a separate copy,
not shared code, matching this project's existing pattern of not cross-importing between
BAP's and BPP's independent Django apps.
"""
...
def initiate_payment(*, transaction_id: str, amount) -> None:
