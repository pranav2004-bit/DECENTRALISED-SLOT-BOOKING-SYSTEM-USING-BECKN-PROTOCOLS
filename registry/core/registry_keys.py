...
_EPHEMERAL_SIGNING_KEY_PATH = Path("/tmp/registry_ephemeral_signing_key.json")  # nosec B108 # noqa: S108
_EPHEMERAL_ENCRYPTION_KEY_PATH = Path("/tmp/registry_ephemeral_encryption_key.json")  # nosec B108 # noqa: S108
